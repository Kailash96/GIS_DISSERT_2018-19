...
<div class="left-nav-bar">
    ...
    Navigations
    <ul>
        <li><a href="admin-home.php" id="home_selected"><i class="logo_space fa fa-home" id="home"></i> Home</a></li>
        <li><a href="register_new_user.php" id="register_selected"><i class="logo_space fa fa-address-book-o" id="registeruser"></i> Register New User</a></li>
        ...
        <li><a href=""><i class="logo_space fa fa-cogs"></i> Settings</a></li>
    </ul>
</div>