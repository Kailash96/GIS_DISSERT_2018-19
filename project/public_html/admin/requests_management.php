...
<html>
    <head>
        ...
        <script>
            ...
            function edit(nic, fullname, uemail){
                ...
                activate.send("nic=" + nic + "&fname=" + fullname + "&email=" + uemail);
            ...
            <div class="reg-form-box">
                <div style="padding:10px;">
                    <form method="POST" onsubmit="edit(nic.value, fullname.value, email.value)" style="font-size:12px;font-weight:bold;color:#9F9F9F">
                        ...
                        Email <input type="text" name="email" placeholder="Email" class="input-box" style="text-transform:none" required /><br/><br/>
